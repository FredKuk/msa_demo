package com.demo.microservices.composite.services;
...
import com.demo.api.core.user.User;
import com.demo.api.core.user.UserService;
import com.demo.api.core.customer.Customer;
import com.demo.api.core.customer.CustomerService;
// import com.demo.api.core.account.Account;
// import com.demo.api.core.account.AccountService;
import com.demo.api.event.Event;
import com.demo.util.exceptions.InvalidInputException;
import com.demo.util.exceptions.NotFoundException;
import com.demo.util.http.HttpErrorInfo;

import java.io.IOException;

import static reactor.core.publisher.Flux.empty;
import static com.demo.api.event.Event.Type.CREATE;
import static com.demo.api.event.Event.Type.DELETE;
import static com.demo.api.event.Event.Type.UPDATE;


@EnableBinding(CompositeIntegration.MessageSources.class)
@Component
public class CompositeIntegration implements UserSevice, CustomerService {//, AccountService {
